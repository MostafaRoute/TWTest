...
document.querySelector(".mealNameInput").addEventListener("input", function () {
    $(".displaySearch").removeClass("hidden")
    console.log(this.value);
    searchByName(this.value)
})

document.querySelector(".mealLetterInput").addEventListener("input", function () {
    $(".displaySearch").removeClass("hidden")
    console.log(this.value);
    ...
    for (let i = 0; i < data.length; i++) {
        categories += `
                <div onclick="getMealCategoryRecipes('${data[i].strCategory}')" class="w-full md:w-[calc(25%-1rem)] mb-4 relative group overflow-hidden rounded-lg cursor-pointer">
                    ...
                    <div
                        class="layer px-3 w-full flex flex-col justify-center align-middle text-center top-0 bottom-0 bg-white group-hover:translate-y-0 translate-y-full duration-500 bg-opacity-75 absolute">
    ...
    for (let i = 0; i < data.length; i++) {
        areas += `
            <div onclick="displayAreaMeals('${data[i].strArea}')" class="w-full md:w-[calc(25%-1rem)] mb-4 relative group overflow-hidden rounded-lg cursor-pointer">
                    <img src="./imgs/location.png" class="w-6/12 m-auto" alt="">
